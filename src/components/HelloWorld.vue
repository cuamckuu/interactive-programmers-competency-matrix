  ...
  i18n: {
    messages: {
      ...
      ru: {
        meta: {
          header: 'Куда я попал?',
          info: 'Это интерактивная версия \'Матрицы компетенций программиста\', которая была создана <a href=\'https://sijinjoseph.netlify.app\'>Sijin Joseph</a>. Главным отличием этой версии является возможность делать отметки и получать статистику по своим навыкам и рекомендации по их улучшению. Кроме того, данные о вашем уровне сохраняются в локальное хранилище браузера, поэтому не бойтесь закрыть вкладку и вернуться позже. Русский перевод основан на <a href=\'https://github.com/omreps/programmer-competency-matrix\'>этом Github проекте</a>.',
